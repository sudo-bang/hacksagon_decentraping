    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-20 lg:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/20 border border-blue-400/30 backdrop-blur-sm mb-8">
              <span className="text-blue-300 text-sm font-medium">🚀 Built on Solana • Decentralized Monitoring</span>
            </div>
            
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-blue-300 bg-clip-text text-transparent leading-tight">
              DecentraPing
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link href="#" className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-xl font-semibold text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                <span className="flex items-center justify-center gap-2">
                  Monitor Your Site
                  <span className="group-hover:translate-x-1 transition-transform">→</span>
                </span>
              </Link>
              <Link href="#" className="px-8 py-4 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-600 rounded-xl font-semibold text-white backdrop-blur-sm hover:shadow-lg transform hover:scale-105 transition-all duration-200">
                Become a Validator
              </Link>
            </div>
      ...
      <section className="py-20 px-6 bg-slate-800/30 backdrop-blur-sm">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Feature Card 2 */}
            <div className="group bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-2xl p-8 border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-purple-400">Blockchain Security</h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            {/* Feature Card 4 */}
            <div className="group bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-2xl p-8 border border-slate-700/50 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-orange-400">Security Checks</h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            {/* Feature Card 5 */}
            <div className="group bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-cyan-400">Earn Rewards</h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            {/* Feature Card 6 */}
            <div className="group bg-gradient-to-b from-slate-800/50 to-slate-900/50 rounded-2xl p-8 border border-slate-700/50 hover:border-pink-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-3 text-pink-400">Analytics Dashboard</h3>
              <p className="text-slate-300 leading-relaxed">
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-3xl p-8 lg:p-12 border border-blue-500/20 backdrop-blur-sm">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-blue-900/20 to-purple-900/20">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="#" className="group px-10 py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-xl font-semibold text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
              <span className="flex items-center justify-center gap-2">
                Start Monitoring Now
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </span>
            </Link>
            <Link href="#" className="px-10 py-4 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-600 rounded-xl font-semibold text-white backdrop-blur-sm hover:shadow-lg transform hover:scale-105 transition-all duration-200">
              Learn More
            </Link>
          </div>
        </div>
